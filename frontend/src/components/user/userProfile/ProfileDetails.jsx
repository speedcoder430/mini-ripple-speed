...
function ProfileDetails() {
    ...
    const items = [
        ...
        { label: "Phone number", icon: "/admin/profile/call.png", value: "+234 000 000 000" },
    ];
            ...
            <div className="flex w-full justify-start">
                <div className="flex min-w-[150px]">
                    <div className="relative w-[100px] h-[100px] rounded-full shadow-sm mr-6">
                        <img src="/page/userProfile/profile_image.png" alt="profile-image" />
                    </div>
                    <div className="flex flex-col items-start justify-center px-6 border-l-4 border-blue-500 h-[100px] text-[20px]">
                        <p className="font-['Amble'] font-bold leading-8">Diala Victor</p>
                        <p className="font-['Amble'] leading-5">+234 000 000 000</p>
