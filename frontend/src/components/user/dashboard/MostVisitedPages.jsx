...
const mockGaData = [
    { pagePath: '/', screenPageViews: '120' },
    { pagePath: '/dashboard', screenPageViews: '95' },
    { pagePath: '/contact-us', screenPageViews: '75' },
    { pagePath: '/about', screenPageViews: '55' },
    { pagePath: '/services', screenPageViews: '45' },
    { pagePath: '/faq', screenPageViews: '30' },
    { pagePath: '/random-page', screenPageViews: '25' }, // to test fallback naming
  ];

const MostVisitedPagesChart = ({ gaData = mockGaData }) => {
