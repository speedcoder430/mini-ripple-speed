...
const mockGaData = [
    { deviceCategory: 'mobile', sessions: '150' },
    { deviceCategory: 'desktop', sessions: '300' },
    { deviceCategory: 'tablet', sessions: '50' },
    { deviceCategory: 'mobile', sessions: '100' },
    { deviceCategory: 'desktop', sessions: '200' },
];

const DeviceUsageStatisticsChart = ({ gaData = mockGaData }) => {
