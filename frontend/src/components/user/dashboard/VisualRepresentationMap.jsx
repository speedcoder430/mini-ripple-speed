...
const mockGAData = [
    ...
    { country: "India", activeUsers: "90" },
    { country: "Germany", activeUsers: "60" },
    { country: "France", activeUsers: "40" },
    { country: "Japan", activeUsers: "30" },
    { country: "Brazil", activeUsers: "70" },
    { country: "South Africa", activeUsers: "20" },
];
...
export default function VisualRepresentationMap({ gaData }) {
    ...
    useEffect(() => {
        const dataToUse = Array.isArray(gaData) ? gaData : mockGAData;
