...
function PlanCard({ planName, features, price, duration, buttonText, ManagePlan }) {
    return (
        <article className="flex flex-wrap flex-1 gap-10 justify-between items-end p-6 my-auto rounded-lg shadow-sm bg-neutral-50 h-[190px] font-['Jost'] max-md:px-5 max-md:max-w-full">
            ...
            <div className="flex flex-col font-semibold w-[155px]">
                ...
                <button onClick={ManagePlan} className="gap-2.5 self-stretch px-6 py-3.5 w-full text-base leading-none rounded-md bg-slate-900 mt-3 text-neutral-50 max-md:px-5">
                    {buttonText}
                </button>
            </div>
        </article>
